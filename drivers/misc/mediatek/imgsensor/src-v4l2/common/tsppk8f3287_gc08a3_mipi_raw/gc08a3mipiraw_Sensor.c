...
static void sensor_init(struct subdrv_ctx *ctx)
{
	...
	table_write_cmos_sensor(ctx, gc08a3_init_addr_data,
...
static void preview_setting(struct subdrv_ctx *ctx)
{
	...
	table_write_cmos_sensor(ctx, gc08a3_1632x1224_addr_data,
...
static void capture_setting(struct subdrv_ctx *ctx, kal_uint16 currefps)
{
	...
	table_write_cmos_sensor(ctx, gc08a3_3264x2448_addr_data,
...
static void slim_video_setting(struct subdrv_ctx *ctx)
{
	...
	table_write_cmos_sensor(ctx, gc08a3_1280x720_addr_data,
...
const struct subdrv_entry tsppk8f3287_gc08a3_mipi_raw_entry = {
	.name = "tsppk8f3287_gc08a3_mipi_raw",
	.id = GC08A3_SENSOR_ID + 1,
	.pw_seq = pw_seq,
